...
image::img/[CSSC2016]SwingSample1の実行結果.png[result1]
...
[source, java]
----
include::code/MyJPanelString.java[lines=15..20]
----
...
image::img/[CSSC2016]SwingSample3の実行結果.png[result2]
...
image::img/drawOval.png[drawOval]
...
=======
=======
>>>>>>> 3062b483891d4f51341b37a190cd74ecbc97bbbd
